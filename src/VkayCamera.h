...
{
	vkCmdBindDescriptorSets(vkr->frames[vkr->frame_idx_inflight].cmd_buffer_gfx, VK_PIPELINE_BIND_POINT_GRAPHICS, camera->m_pipeline_layout, 0, 1, &camera->m_set_global[vkr->frame_idx_inflight], 0, NULL);
